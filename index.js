...
function andy() {
    // const allocations = partition.allocateBallsIntoUrns([55, 17, 38], [8, 8, 9, 9, 12, 8, 26, 30]);
    const allocations = partition.allocateTrackersIntoUrns([55, 17, 38], [8, 8, 9, 9, 12, 8, 26, 30], [0, 0, 1, 1, 2, 3, 4, 5]);
